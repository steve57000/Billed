...
export const modal = () => (`
  <div class="modal fade" id="modaleFileAdmin" data-testid="modaleFileAdmin" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        ...
        <div class="col-sm">
          <label for="file" class="bold-label">Justificatif</label>
            ...
            <div class='icons-container'>
              ...
              <span id="icon-download-d" data-testid="icon-download-d" data-bill-url="${bill.fileUrl}"> ${downloadWhiteIcon} </span>
            </div>
          </div>
        </div>
      </div>
